...
const form = useForm({
    ...
    fecha: props.gasto.fecha.split('T')[0],
    descripcion: props.gasto.descripcion,
    monto: props.gasto.monto,
    comprobante: props.gasto.comprobante || '',
    observaciones: props.gasto.observaciones || '',
});

const submit = () => {
    form.put(route('gastos.update', props.gasto.gasto_id));
};
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Modificar datos del gasto registrado
                    </p>
                </div>
            </div>
        </template>
