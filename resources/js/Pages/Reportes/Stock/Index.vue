        ...
        <div class="py-6">
            <div class="max-w-7xl mx-auto space-y-6">
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 border-b-4 border-indigo-500">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <div class="text-xs text-gray-400 mt-1">Total en inventario</div>
                            </div>
                ...
                <div class="bg-white shadow-sm sm:rounded-lg p-4 flex flex-col md:flex-row gap-4 items-center justify-between">
                    ...
                    <ExportDropdown
                        :exportUrl="route('reportes.stock.exportar')"
                        :params="{ bajo_stock: form.bajo_stock ? '1' : '0' }"
                    />
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6" v-if="stocks.data.length > 0 || kpis.total_unidades > 0">
                    <div class="bg-white shadow-sm sm:rounded-lg p-6">
                        ...
                        <div class="h-64 relative w-full">
                             <Bar :data="graficos.riesgo" :options="{
                                responsive: true,
                                ...
                                plugins: {
                                    ...
                                    tooltip: {
                                        ...
                                        padding: 12,
                                        cornerRadius: 8,
                                        callbacks: { label: (ctx) => `  ${ctx.raw} unidades disponibles` }
                                    }
                                },
                                scales: {
                    ...
                    <div class="bg-white shadow-sm sm:rounded-lg p-6">
                        <div class="flex items-center justify-between mb-4">
                            <h3 class="text-lg font-bold text-gray-800">Stock por Categoría</h3>
                            <span class="text-xs px-2 py-1 bg-indigo-100 text-indigo-700 rounded-full font-semibold">Top 8</span>
                        </div>
                        <div class="h-64 relative w-full flex justify-center">
                            <Doughnut :data="graficos.categorias" :options="{
                                responsive: true,
                                maintainAspectRatio: false,
                                cutout: '55%',
                                plugins: {
                                    ...
                                    tooltip: {
                                        ...
                                        callbacks: {
                                            label: (ctx) => {
                                                ...
                                                return `  ${new Intl.NumberFormat('es-AR').format(ctx.raw)} unidades (${pct}%)`;
                                            }
                                        }
                                    }
                                }
                                ...
                                <tr v-if="stocks.data.length === 0">
                                    <td colspan="5" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center justify-center">
                                            ...
                                            <button @click="form.bajo_stock = false" class="mt-2 text-indigo-600 hover:text-indigo-800 text-sm underline font-medium">
                                                Limpiar filtros
                                            </button>
                                        </div>
                                    </td>
