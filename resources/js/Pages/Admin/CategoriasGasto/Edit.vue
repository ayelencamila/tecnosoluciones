...
const submit = () => {
    form.put(route('admin.categorias-gasto.update', props.categoria.categoria_gasto_id));
};
</script>

<template>
    <AppLayout>
        <Head title="Editar Categoría de Gasto" />
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">
                        Modificar categoría: {{ categoria.nombre }}
                    </p>
                </div>
            </div>
        </template>
