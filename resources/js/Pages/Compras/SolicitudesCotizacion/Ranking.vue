                ...
                <div v-else class="bg-white rounded-lg shadow-sm overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
                        <h3 class="text-sm font-bold text-gray-700 uppercase flex items-center gap-2">
                            ...
                            Ranking por cobertura de productos y precio
                        </h3>
                        <p class="text-xs text-gray-500 mt-1">
                            Ordenado por mayor cobertura de productos solicitados, luego por menor precio. Seleccione la mejor oferta para generar la Orden de Compra.
                        </p>
                    </div>
                                ...
                                >
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <div class="flex items-center justify-center gap-0.5">
                                            <svg v-for="i in 5" :key="i" class="w-3.5 h-3.5" :class="i <= Math.round(oferta.calificacion || 0) ? 'text-amber-400' : 'text-gray-200'" fill="currentColor" viewBox="0 0 20 20">
                                        ...
                                        <div class="flex flex-col items-center">
                                            ...
                                            <div class="w-16 bg-gray-200 rounded-full h-1.5 mt-1">
                                                <div 
                                                    ...
                                                    :class="oferta.cotizo_completo ? 'bg-green-500' : 'bg-amber-500'"
                                                    :style="{ width: (oferta.cobertura || 0) + '%' }"
                                                ></div>
                                            </div>
                                            <span v-if="oferta.cotizo_completo" class="text-green-600 text-[10px] font-medium mt-0.5">
                                                Completo
                                            </span>
                                            <span v-else class="text-amber-600 text-[10px] font-medium mt-0.5">
                                                Parcial
                                            </span>
                                        </div>
                                    </td>
