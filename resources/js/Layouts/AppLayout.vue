...
const navItems = computed(() => {
    ...
    if (page.props.auth.user.role === 'admin') {
        ...
        items.push({
            ...
            route: 'admin.estados-producto.index',
        ...
        items.push({
            ...
            icon: 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10' // Icono de caja/archivo
        });

        items.push({
            name: 'Tipos de Cliente',
            route: 'admin.tipos-cliente.index',
            icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z'
        });

        items.push({
            name: 'Estados de Cliente',
            route: 'admin.estados-cliente.index',
            icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z'
        });

        items.push({
            name: 'Medios de Pago',
            route: 'admin.medios-pago.index',
       ...
       items.push({
            ...
            icon: 'M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z' // Icono de celular
        });
    }
