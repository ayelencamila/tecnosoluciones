    ...
    public function run(): void
    {
        $configuraciones = [
            ...
            [
                ...
                'valor' => 'true',
                'descripcion' => 'Habilitar sistema de bonificaciones por demora en reparaciones',
                
            ],
            [
                'clave' => 'bonificacion_1_3_dias',
                'valor' => '10',
                'descripcion' => 'Porcentaje de bonificación para demoras de 1-3 días sobre SLA',
                
            ],
            [
                'clave' => 'bonificacion_4_7_dias',
                'valor' => '20',
                'descripcion' => 'Porcentaje de bonificación para demoras de 4-7 días sobre SLA',
                
            ],
            [
                'clave' => 'bonificacion_mas_7_dias',
                'valor' => '30',
                'descripcion' => 'Porcentaje de bonificación para demoras de más de 7 días sobre SLA',
                
            ],
            [
                'clave' => 'bonificacion_tope_maximo',
                'valor' => '50',
                'descripcion' => 'Tope máximo de bonificación aplicable (% sobre mano de obra)',
            ...
            [
                ...
                'descripcion' => 'Estados que pausan el conteo de días efectivos para SLA (separados por coma)',
            ...
            [
                ...
                'descripcion' => 'Plantilla WhatsApp para notificar reparación demorada. Variables: {cliente}, {codigo}, {dias}, {motivo}, {bonificacion}',
            ...
            [
                ...
                'descripcion' => 'Template de bonificación para insertar en mensaje de demora. Variables: {porcentaje}, {monto_original}, {monto_bonificado}',
